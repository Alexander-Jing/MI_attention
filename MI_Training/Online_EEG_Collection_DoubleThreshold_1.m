...
% 运动想象基本参数设置
subject_name = 'Jyt_test_0130_online_debug';  % 被试姓名
sub_offline_collection_folder = 'Jyt_test_0130_offline_debug_20240130_105530543_data';  % 被试的离线采集数据
subject_name_offline =  'Jyt_test_0130_offline_debug';  % 离线收集数据时候的被试名称
