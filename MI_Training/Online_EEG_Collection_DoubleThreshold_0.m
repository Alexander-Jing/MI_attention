...
% 运动想象基本参数设置
subject_name = 'Jyt_test_0110_online_test';  % 被试姓名
sub_offline_collection_folder = 'Jyt_test_0108_offline_20240109_222305628_data';  % 被试的离线采集数据
subject_name_offline =  'Jyt_test_0108_offline';  % 离线收集数据时候的被试名称
