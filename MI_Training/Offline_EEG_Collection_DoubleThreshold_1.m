...
% 运动想象基本参数设置
subject_name = 'Jyt_test_0129_offline_debug';  % 被试姓名
...
% 计算四分位数
[quartile_caculation, min_max_value] = Offline_Bootstrapping_quartile(mu_suppressions, 'mu_suppressions', 1000);

% 存储相关数据
save([foldername_Scores, '\\', ['Offline_EEGMI_Scores_', subject_name], '.mat' ],'scores_task','EI_indices','mu_powers', ...
    'mu_suppressions','EI_index_scores', 'mean_std_EI_score','mean_std_muSup','quartile_caculation',"min_max_value"); 
