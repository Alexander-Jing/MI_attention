...
plot_signal_and_fit_double(mu_suppresions(1,mu_suppresions(2,:)==1), 'Mu sup online 1', mu_suppressions_compare(1,mu_suppressions_compare(2,:)==1), 'Mu sup compare 1', 'mu sup');
...
plot_signal_and_fit_double(EI_index_scores(1,EI_index_scores(2,:)==1), 'EI online 1', EI_index_scores_compare(1,EI_index_scores_compare(2,:)==1), 'EI compare 1', 'EI');
