...
% 运动想象基本参数设置
subject_name = 'Jyt_online_test';  % 被试姓名
sub_offline_collection_folder = 'Jyt_online_test_offline';  % 被试的离线采集数据
...
%% 生成mu衰减的追踪轨迹
% 读取之前的离线采集的数据
foldername_Scores = [sub_offline_collection_folder, '\\Offline_EEGMI_Scores_', subject_name]; % 指定之前存储的离线文件夹路径和名称
