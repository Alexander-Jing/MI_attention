...
subject_name_comparison = 'Jyt_test_0310_post_control';
sub_comparison_collection_folder = 'Jyt_test_0310_post_control_20240310_212613989_data';
...
for trial_idx = 1:trial_nums
    ...
    for MI_idx = 1:window_num   
        rawdata_MI = rawdata_trial(:, 1 + (MI_start + (MI_idx - 1) * window_length/2) * sample_freq:(MI_start + (MI_idx - 1) * window_length/2 + window_length) * sample_freq);
